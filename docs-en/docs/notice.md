...
- A <span style={{color:"red",}}>**12 V DC power supply rated at ≥ 3 A**</span> is required. The power supply should feature overcurrent, overvoltage, and surge protection.
