...
2. Set up your RUBIK Pi with Wi-Fi and SSH enabled. Instructions for this set up can be found [here](../1.0.0-u/Document%20Home/1.quick-start/3.set-up-your-device.md). 
