---
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-en/docs/rubik-pi-3-user-manual/1.0.0-u/7.Application Development and Execution Guide/3.IMSDK/3.Develop-app.md
---
...
```
3️⃣ You'll need a camera (either built-in, on the RUBIK Pi 3) or a USB webcam.
...
```
If you're on the RUBIK Pi 3, and want to use the built-in camera:  
```python
...
If you see an error like (using the built-in camera on the RUBIK Pi 3):
