...
3. Download *dtb.bin* from the [Canonical website](https://ubuntu.com/download/qualcomm-iot) and copy it to the *rb3_ubuntu_images* folder.

4. Download *ubuntu-24.04-preinstalled-server-arm64+rubikpi3-20250912-127.img.xz* from the [Canonical website](https://ubuntu.com/download/qualcomm-iot) and extract it to obtain the raw image file:
...
5. Copy the Ubuntu raw image file `ubuntu-24.04-preinstalled-server-arm64+rubikpi3-20250912-127.img` to the *rubikpi3_Ubuntu_images* folder.
    ...
    ```
6. Download *rawprogram0.xml* from the [Canonical website](https://ubuntu.com/download/qualcomm-iot) and copy it to the *rubikpi3_ubuntu_images* folder.
