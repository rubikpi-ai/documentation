...
### Fan
  ...
  RUBIK Pi 3 does not come with a fan. In scenarios with high computational demands, it is recommended that you purchase and install a fan. For details, refer to the [Peripheral Compatibility List](/documentation/docs-en/docs/peripheral-compatibility-list.md) section.
...
### How can I flash the Configuration Data Table (CDT)?
  ...
  Ensure that the device is in EDL mode. For more information, refer to [Enter EDL mode.](1.quick-start/1.update-software.md#flash-using-the-qdl-tool)
  :::
...
### How can I configure Universal Flash Storage (UFS)?
  ...
  * Refer to [Flash using the QDL tool.](1.quick-start/1.update-software.md#flash-using-the-qdl-tool)

### How can I force the device into Emergency Download (EDL) mode?

  * Refer to [Enter EDL mode.](1.quick-start/1.update-software.md#enter-edl-mode)
...
### How can I use Minicom to set up the debug UART?
  ...
  * Refer to [Set up the debug UART](1.quick-start/2.set-up-your-device.md#set-up-the-debug-uart).
