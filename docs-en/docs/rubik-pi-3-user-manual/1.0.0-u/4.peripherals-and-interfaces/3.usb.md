---
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-en/docs/rubik-pi-3-user-manual/1.0.0-u/4.peripherals-and-interfaces/3.usb.md
---
...
* Operating mode (Type-C interface)

  ```shell
  cat /sys/kernel/debug/usb/a600000.usb/mode
  ```
  :::note
    Operating mode (USB 2.0 Type-A) - cat /sys/kernel/debug/usb/8c00000.usb/mode
  :::
