...
### Fan
  ...
  RUBIK Pi 3 does not come with a fan. In scenarios with high computational demands, it is recommended that you purchase and install a fan. For details, refer to the [Accessories](/peripheral-compatibility-list.md) section.
...
### How can I flash the Configuration Data Table (CDT)?
  ...
  Ensure that the device is in EDL mode. For more information, refer to [Enter EDL mode.](1.%20Quick%20Start/1.Update%20software.md#enterEDL)
  :::
...
### How can I configure Universal Flash Storage (UFS)?
  ...
  * Refer to [Flash using the QDL tool.](1.%20Quick%20Start/1.Update%20software.md#flashQDL)

### How can I force the device into Emergency Download (EDL) mode?

  * Refer to [Enter EDL mode.](1.%20Quick%20Start/1.Update%20software.md#enterEDL)
...
### How can I use Minicom to set up the debug UART?
  ...
  * Refer to [Set up the debug UART](1.%20Quick%20Start/2.Set%20up%20your%20device.md#setUart).
...
### How can I switch from the desktop version to the server version?
  ...
  1. Refer to [Connect to the network.](1.%20Quick%20Start/2.Set%20up%20your%20device.md#conNET) Ensure that the network connection is normal.
