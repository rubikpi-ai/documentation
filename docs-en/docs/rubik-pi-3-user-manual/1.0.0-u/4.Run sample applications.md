...
:::note
  ...
  * To view the display output, connect an HDMI display to the HDMI port of RUBIK Pi 3 by referring to [Connect an HDMI display](1.%20Quick%20Start/2.Set%20up%20your%20device.md#conHDMI).
