...
Currently, RUBIK Pi 3 is compatible with the two types of camera modules listed in [Accessories](/peripheral-compatibility-list.md). The following table lists the supported resolutions for each camera module.
...
RUBIK Pi 3 supports the 22-pin FPC with a 0.5mm pitch and a 0.3±0.05mm thickness. For the compatible accessory, refer to [Accessories](/peripheral-compatibility-list.md).
