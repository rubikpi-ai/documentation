...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [安装 Qualcomm 神经网络处理引擎 SDK](./4.%20AI%20开发者工作流程.md#installSDK)<p>[设置 Qualcomm 神经网络处理 SDK](./4.%20AI%20开发者工作流程.md#SetSDK)</p> | [模型转换](./4.%20AI%20开发者工作流程.md#modelconv)<p>[模型量化](./4.%20AI%20开发者工作流程.md#modelquant)</p> | [模型部署](./4.%20AI%20开发者工作流程.md#modeldeploy) | [C/C++](https://docs.qualcomm.com/bundle/publicresource/topics/80-63442-2/api.html) |
...
| **下载方式**                                                                                                                     | **前提条件**                                         | **可用版本**             |
| ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------- |
| [直接下载](./4.%20AI%20开发者工作流程.md#diredown)                     | 无需任何前提条件即可下载                                     | v2.22.6（SDK 每季度更新一次） |
| [Qualcomm Package Manager](./4.%20AI%20开发者工作流程.md#Qpackmanager) | 需要拥有有效的 Qualcomm ID。Qualcomm Package Manager 工具。 | SDK 每月更新一次           |
...
如果通过直接下载的方式安装，aaaaa 表示解压后的 SDK 所在路径。
...
对于 RUBIK Pi 3，使用路径 *aaaaa/lib/aarch64-oe-linux-gcc11.2* 和 *aaaaa/bin/aarch64-oe-linux-gcc11.2*.*&#x20;*&#x4E2D;的以下文件。
...
| **环境配置**                                                                                                                                                                                                                                                | **定制**                                                                                                                                                                                                              | **运行推理**                                                                                                 | **API 手册**                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [安装 AI Engine Direct](./4.%20AI%20开发者工作流程.md#installAIdir)<p>[设置 Qualcomm AI Engine Direct](./4.%20AI%20开发者工作流程.md#setAIdire) </p>| [模型转化与量化](./4.%20AI%20开发者工作流程.md#modelconvquant)<p>[模型编译](./4.%20AI%20开发者工作流程.md#modelcompile) </p>| [部署模型](./4.%20AI%20开发者工作流程.md#deploymodel) | [C/C++](https://docs.qualcomm.com/bundle/publicresource/topics/80-63442-50/api.html) |
...
:::note
>
> 如果主机运行的是 Windows 或 macOS 操作系统软件，须按照 [Windows 11 开发环境搭建](./1.%20快速开始.md#setwin)、 [Mac 开发环境搭建（Arm64）](./1.%20快速开始.md#setmac)、 [Mac 开发环境搭建（x86\_64）](./1.%20快速开始.md#set86)提供的步骤安装虚拟机。后续步骤必须在运行 Ubuntu 22.04 LTS 的虚拟机中执行。       &#x20;**&#x20; &#x20;**
:::
...
| **下载方式**                                                                                                                     | **前提条件**                                         | **可用版本**             |
| ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------- |
| [直接下载](./4.%20AI%20开发者工作流程.md#downdirec)                     | 无需任何前提条件即可下载。                                    | v2.22.6（SDK 每季度更新一次） |
| [Qualcomm Package Manager](./4.%20AI%20开发者工作流程.md#QuaMana) | 需要拥有有效的 Qualcomm ID。Qualcomm Package Manager 工具。 | SDK 每月更新一次。          |
...
:::note
>
> *bbbbb&#x20;*&#x6307;向已安装 AI Engine Direct SDK 的根路径。
>
> * 如果通过直接下载方式下载，须将 *bbbbb&#x20;*&#x8BBE;置为下载并解压 SDK 的根目录。
>
...
对于 RUBIK Pi 3，使用路径 *bbbbb/bin/aarch64-oe-linux-gcc11.2* &#x548C;*bbbbb/lib/aarch64-oe-linux-gcc11.2.&#x20;*&#x4E2D;的文件。
