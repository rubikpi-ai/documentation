...
1. 首先设置交叉编译环境，具体步骤可参考 [安装交叉编译工具](./1.%20快速开始.md#installcrosstool)小节：
...
3. 到 *bin* 目录将编译生成物拷贝到交叉编译工具链的 *sysroot&#x20;*&#x76EE;录下，如下 */home/zhy/QCOM/sdk* 为交叉编译工具的安装路径，具体可参考 [代码编译](./1.%20快速开始.md#codecompile)：
