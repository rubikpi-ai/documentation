...
1. First, set up the cross-compilation environment. For detailed steps, refer to [Install cross-compilation tools](./1.%20Get%20Started.md#Installcross-compilationtools).
...
3. Go to the *bin* directory and copy the compilation artifact to the *sysroot* directory of the cross-compilation toolchain. As shown in the following code, */home/zhy/QCOM/sdk* is the installation path of the cross-compilation tool. For details, refer to [Compile code](./1.%20Get%20Started.md#compilecode).
