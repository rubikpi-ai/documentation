...
* Examples of some commands:
  ...
  * Enable UART6 in two-wire mode:
    ...
    After restarting the system, the `/dev/ttyHS6` node will appear. Use the method described in [UART](./2.%20Peripherals%20and%20Interfaces.md#224UART) to test UART6.
