...
* Compile programs
  ...
  * Cross-compile the program. For details, refer to [Use the cross-compilation tools](./1.%20Get%20Started.md#usecrosstool).
...
* Raspberry Pi High Quality Camera (IMX477/M12 Mount)  [Purchase link](https://www.raspberrypi.com/products/raspberry-pi-high-quality-camera/)
  ...
  In the demonstration in [Qualcomm IM SDK](./5.%20Qualcomm%20IM%20SDK.md#QIMSDK), the IMX477 camera uses the WS1053516 lens.
...
1. Check the camera module connection.
   ...
   For details, refer to [Connect the camera cable](./2.%20Peripherals%20and%20Interfaces.md#section-2.4.1).
...
* Pair with devices:
  ...
  Before pairing with a remote device, [perform a Bluetooth discovery scan](./2.%20Peripherals%20and%20Interfaces.md#BTdiscovery) to ensure the remote device is available.
...
Before you begin, set up the device as described in [Set up device for Bluetooth Low Energy GATT functions](./2.%20Peripherals%20and%20Interfaces.md#SetforBTGATT).
...
To get the Bluetooth address of the remote device, run a [Bluetooth Low Energy GATT scan](./2.%20Peripherals%20and%20Interfaces.md#StartBTGATT).
:::
...
`<Flags>` are the flag values of the characteristic. For values, see [Flag values](./2.%20Peripherals%20and%20Interfaces.md#Flagvalues).
...
`<Flags>` are the flag values of the descriptor. For values, see [Flag values](./2.%20Peripherals%20and%20Interfaces.md#Flagvalues).
...
Before you begin, add the intended services as a [primary service](./2.%20Peripherals%20and%20Interfaces.md#addprimary).
...
To read a characteristic value, do the following from the `menu gatt` menu:
     1. [Select an attribute](./2.%20Peripherals%20and%20Interfaces.md#selectattr).
...
For HOGP functions, refer to [Perform Bluetooth HOGP functions](./2.%20Peripherals%20and%20Interfaces.md#BTHOGP).
...
2. Run a [Start Bluetooth Low Energy GATT scan](./2.%20Peripherals%20and%20Interfaces.md#StartBTGATT) on the DUT for the Bluetooth wireless mouse.

3. [Connect a remote device](./2.%20Peripherals%20and%20Interfaces.md#ConnectRMT) to the Bluetooth wireless mouse.
...
- Procedure
   ...
   2. Go to the **Transport submenu** or **Player submenu** as needed.
     ...
     export                                            Print environment variables
     ```
     To perform **Transport submenu** functions in the source, refer to [Perform Bluetooth A2DP source functions](./2.%20Peripherals%20and%20Interfaces.md#BTADPsource).
     To perform **Transport submenu** functions in the sink, refer to [Perform Bluetooth A2DP sink functions](./2.%20Peripherals%20and%20Interfaces.md#BTADPsink).
     ...
     export                                            Print environment variables
     ```
     To perform **Player submenu** functions in the sink, refer to [Perform Bluetooth A2DP sink functions](./2.%20Peripherals%20and%20Interfaces.md#BTADPsink).

* [Perform Bluetooth A2DP source functions](./2.%20Peripherals%20and%20Interfaces.md#BTADPsource)

  You can perform Bluetooth A2DP source functions using the `bluetoothctl` menu, `menu transport` submenu, and `paplay` commands.

* [Perform Bluetooth A2DP sink functions](./2.%20Peripherals%20and%20Interfaces.md#BTADPsink)
...
Before you begin, set up your device and go to the required menu as described in [Set up device for A2DP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforA2DP).
...
[Configure the DUT for HFP client functions](./2.%20Peripherals%20and%20Interfaces.md#DUTforHFPclient) or [Configure the DUT for HFP audio gateway functions](./2.%20Peripherals%20and%20Interfaces.md#DUTforHFPgateway), as required.

<a id="DUTforHFPclient"></a>
**Configure the DUT for HFP client functions**

After the [Set up the device for HFP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforHFP)**&#x20;**&#x6F;perations, do the following for an HFP client:
...
For HFP client functions, refer to [Perform Bluetooth HFP client functions](./2.%20Peripherals%20and%20Interfaces.md#performHFPclient).

<a id="DUTforHFPgateway"></a>
**Configure the DUT for HFP audio gateway functions**

After the [Set up the device for HFP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforHFP)**&#x20;**&#x6F;perations, do the following for an HFP audio gateway:
...
For HFP audio gateway functions, refer to [Perform Bluetooth HFP audio gateway functions](./2.%20Peripherals%20and%20Interfaces.md#performHFPgateway).

* [Perform Bluetooth HFP client functions](./2.%20Peripherals%20and%20Interfaces.md#performHFPclient)
  You can perform HFP client functions using the `bluetoothctl` menu and `ofono/test` tools.&#x20;

* [Perform Bluetooth HFP audio gateway functions](./2.%20Peripherals%20and%20Interfaces.md#performHFPgateway)
...
Before you begin, [Set up the device for HFP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforHFP) and [Configure the DUT for HFP client functions](./2.%20Peripherals%20and%20Interfaces.md#DUTforHFPclient).
...
Before you begin, [Set up the device for HFP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforHFP) and [Configure the DUT for HFP audio gateway functions](./2.%20Peripherals%20and%20Interfaces.md#DUTforHFPgateway).
...
This command provides the main menu of obexctl. To perform OPP server and client functions, refer to [Perform Bluetooth OPP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTOPPserver) and [Perform Bluetooth OPP client functions](./2.%20Peripherals%20and%20Interfaces.md#performoppclient).&#x20;
...
* [Perform Bluetooth OPP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTOPPserver)
  You can verify Bluetooth OPP server functionality using the commands provided in the main menu of obexctl.

* [Perform Bluetooth OPP client functions](./2.%20Peripherals%20and%20Interfaces.md#performoppclient)
...
To receive a file in the server role, do the following:
  1. Pair the DUT and the remote device. For instructions, refer to [Pair with devices](./2.%20Peripherals%20and%20Interfaces.md#pairwithDev).
...
Before you begin, set up the device as described in [Set up device for Bluetooth OPP functions](./2.%20Peripherals%20and%20Interfaces.md#SetforBTOPP).
...
* Pair the DUT and the remote device. For instructions, refer to [Pair with devices](./2.%20Peripherals%20and%20Interfaces.md#pairwithDev).
...
To perform FTP client functions, refer to [Perform Bluetooth FTP client functions](./2.%20Peripherals%20and%20Interfaces.md#performBTFTPclient).
...
Before you begin, set up the device as described in [Set up device for Bluetooth FTP functions](2.%20Peripherals%20and%20Interfaces.md#setforBTFTP).
...
Before you begin, [change the current folder](./2.%20Peripherals%20and%20Interfaces.md#changefolder) to the folder of the intended file.
...
This command provides the main menu of **obexctl**. To perform PBAP server and client functions, refer to [Perform Bluetooth PBAP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTPBAPserver) and [Perform Bluetooth PBAP client functions](./2.%20Peripherals%20and%20Interfaces.md#performBTPBAPclient).
...
[Perform Bluetooth PBAP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTPBAPserver)

You can verify Bluetooth PBAP server functionality using the commands provided in the main menu of **obexctl**.

[Perform Bluetooth PBAP client functions](./2.%20Peripherals%20and%20Interfaces.md#performBTPBAPclient)
...
In the BlueZ stack, PBAP server functionality cannot be tested or verified directly as you cannot create contacts on the server. Hence, you must create a PBAP directory on the DUT. For more information about creating a PBAP directory, refer to [Sample PBAP directory](./2.%20Peripherals%20and%20Interfaces.md#samplePBAP).
:::
...
Before you begin, set up the device as described in [Set up device for Bluetooth PBAP functions](./2.%20Peripherals%20and%20Interfaces.md#setforBTPBAP).
...
To pull a phone book, do the following:
  1. [Connect the remote device](./2.%20Peripherals%20and%20Interfaces.md#connectremote).
  2. [Select a phone book object](./2.%20Peripherals%20and%20Interfaces.md#selectphonebookobj)
...
This command provides the main menu of **obexctl**. To perform MAP server and client functions, refer to [Perform Bluetooth MAP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTMAPserver) an&#x64;**&#x20;**[Perform Bluetooth MAP client functions](./2.%20Peripherals%20and%20Interfaces.md#performBTMAPclient).
...
* [Perform Bluetooth MAP server functions](./2.%20Peripherals%20and%20Interfaces.md#performBTMAPserver)
  You can verify Bluetooth MAP server functionality using the commands provided in the main menu of **obexctl**.

* [Perform Bluetooth MAP client functions](./2.%20Peripherals%20and%20Interfaces.md#performBTMAPclient)
...
Before you begin, set up the device as described in [Set up device for Bluetooth MAP functions](./2.%20Peripherals%20and%20Interfaces.md#setforBTMAP).
...
To list messages in a folder, do the following:
  1. [Connect the DUT and the remote device](./2.%20Peripherals%20and%20Interfaces.md#connectRMTDev).
