...
2. Connect the power supply into port 10, as shown in the figure below.&#x20;
   ...
   ![](images/baabfa63-45f7-4d4a-8085-040718e7a161.jpeg)
...
:::note
In the Android Alpha version, you need to download this file and extract it to the *ufs* directory of the image package.
