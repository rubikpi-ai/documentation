...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.1/12.gitHub-operation-guide.md
---
...
可以通过提交 Pull Requset（PR）向 魔方派 3 提交代码，经过审核后，您的代码有可能合入 魔方派 3 的主线，下面是向 魔方派 3 linux 主线分支提交 PR 的一种方式：

1. 登录 GitHhub，访问 魔方派 3 仓库 [https://github.com/rubikpi-ai/linux.](https://github.com/rubikpi-ai/linux)
...
如开发过程中遇到问题、发现 bug、对 魔方派 3 的意见、想要的功能等，以创建 Issue 的方式提出。

1. 登录 GitHub，访问 魔方派 3 仓库 https://github.com/rubikpi-ai/linux。
