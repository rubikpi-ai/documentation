...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.1/11.user-guide-to-rubikpi-config.md
---

# rubikpi_config 使用指南

rubikpi\_config 是一个运行在 魔方派 3 中的配置工具。
...
```sql
This is the config tool for 魔方派. 
