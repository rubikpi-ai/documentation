...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.1/7.qt5-user-guide.md
---
...
魔方派 3支持 PyQt5，如下是一个 PyQt5 的 Demo。
...
w.resize(550, 500)
w.move(600, 300)
w.setWindowTitle('魔方派 3 PyQt5 demo title')
w.show()
sys.exit(app.exec_())
```
...
在 魔方派 3 中使用如下命令运行 demo 程序，执行结果如下所示：
