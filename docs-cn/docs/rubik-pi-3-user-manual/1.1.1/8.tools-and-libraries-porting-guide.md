...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.1/8.tools-and-libraries-porting-guide.md
---

# 工具&库移植指南

魔方派 3 已经将集成常用的工具和库，若开发过程中使用的工具未集成，可参考 cec-clinet 移植方法进行移植：
...
6. 执行下面命令查看编译生成物，如下，cec-client 工具已经生成。因 魔方派 3 中已经集成了 libcec 的库，可以 将 cec-clinet 传输到 魔方派 3 中运行：
