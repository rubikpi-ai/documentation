...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.1-a/2.peripherals-and-interfaces.md
---
...
* 编译程序：
  ...
  * 使用交叉编译，需要将编译出的产物 *uart&#x20;*&#x4F20;输到 魔方派 3 中，如果使用 ADB 传输，命令如下：
...
本小节介绍如何通过 USB 2.0 Type-A接口，将 魔方派 3 配置为 USB 大容量设备（即模拟成 U 盘），来验证安卓 13 设备的 USB Gadget 功能。
...
魔方派 3 拥有 1 个 USB Type-C (SST) 接口的 DisplayPort，如下图5。
...
在 STA 模式（Station）下，设备可连接到一个已经存在的无线网络，以便访问网络资源或互联网，在 魔方派 3 中进行如下操作：
