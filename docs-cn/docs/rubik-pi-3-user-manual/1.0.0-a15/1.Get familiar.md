---
slug: get-familiar
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.0-a15/1.Get%20familiar.md
---
...
**魔方派 3** 采用 **高通® QCS6490** SoC，专为高性能计算和现代开发工作流的无缝集成而设计。本指南介绍如何使用 **Android 15** 设置您的开发板，以便您进行端到端 AI、多媒体和 Android 应用的开发与原型验证。  
魔方派 3 的核心特性如下：  
-- **Qualcomm® Kryo™ 670**  
...
|----------|----------|
| 电源（12V，3A）| 是 |
| USB Type-C 转 USB Type-A 或 Type-C 数据线| 是（用于刷写和 ADB 调试） |
