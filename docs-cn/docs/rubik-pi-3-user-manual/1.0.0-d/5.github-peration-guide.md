...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.0-d/5.github-peration-guide.md
---
...
可以通过提交 Pull Requset 向 魔方派 3 提交代码，经过审核后，您的代码有可能合入 魔方派 3 的主线。以向 魔方派 3 linux 主线分支提交 PR 为例：
