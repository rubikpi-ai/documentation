...
sidebar_position: 6
description: ''
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.0/6.qt5.md
---
...
魔方派 3 支持 PyQt5，如下是一个 PyQt5 的 Demo
