...
可以通过提交 Pull Requset 像 魔方派 3 提交代码，经过审核后，您的代码有可能合入 魔方派 3 的主线，下面是向 魔方派 3 linux 主线分支提交 PR 的一种方式：

* 登录Github，访问魔方派 3仓库 https://github.com/rubikpi-ai/linux
...
如开发过程中遇到问题、发现BUG、对魔方派 3的意见、想要的功能等，以创建 Issue 的方式提出。

* 登录Github，访问魔方派 3仓库，如 https://github.com/rubikpi-ai/linux。
