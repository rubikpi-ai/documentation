...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.0-u/11.linux-kernel.md
---
...
关于可用分支列表，请见 [魔方派 kernel GitHub repository](https://github.com/rubikpi-ai/linux-ubuntu.git)。
:::
