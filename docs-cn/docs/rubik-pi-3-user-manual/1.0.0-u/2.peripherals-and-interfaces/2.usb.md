...
## USB 接口功能验证
    ...
    **使用 Qualcomm IM SDK 中的 GStreamer 配置 USB 摄像头**
    ...
    Qualcomm IM SDK 采用开源多媒体框架 [GStreamer](https://gstreamer.freedesktop.org/) 公开了多媒体和机器学习这两个领域简洁的 API 和易用的插件。有关安装 Qualcomm IM SDK 的信息，请参阅 [快速开始](../3.run-sample-applications.md#runmediaapp) 部分。
