---
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.0.0-u/3.Update-Software/3.2.Flash-using-Qualcomm-Launcher.md
---
...
# 使用Qualcomm Launcher刷写Canonical Ubuntu 24.04
	...
	**e**. 安装成功后，您将看到**Qualcomm Launcher**应用程序界面。
	...
	### 2️⃣ 刷写操作
	**a**. 在Qualcomm Launcher中，选择**开发套件**为魔方派，**目标操作系统**为Ubuntu。
