...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.2/1.get-started.md
---
...
魔方派 3 的 IP 可通过在 魔方派 3 中输入`ifconfig`命令获取。
:::
...
:::note
只能使用 WSL 编译 Qualcomm Linux 软件。要在 魔方派 3 上刷写软件，请参阅 [Windows 烧录方法](./1.get-started.md#flashwin)。
:::
...
:::note
   ...
   - 在 魔方派 3 终端输入：`reboot bootloader`，进入 fastboot 模式后，魔方派 3 上的蓝灯会亮起来。
