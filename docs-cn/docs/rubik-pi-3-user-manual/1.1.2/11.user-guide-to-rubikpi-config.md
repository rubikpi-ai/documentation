...
custom_edit_url: https://github.com/rubikpi-ai/documentation/blob/main/docs-cn/docs/rubik-pi-3-user-manual/1.1.2/11.user-guide-to-rubikpi-config.md
---
...
:::note
>
> 在官方发布的镜像中，rubikpi_config 工具可能并非最新版本，若您在使用过程中发现了问题，可访问 https://github.com/rubikpi-ai/tools/tree/rubikpi_config 根据 README 中的提示更新工具
:::
