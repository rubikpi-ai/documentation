(function() {
    ...
    const template = `
        ...
        <div class="fb-window" id="fb-window">
            ...
            <h3 class="fb-title">您的反馈是我们前进的动力</h3>
            <form id="fb-form">
            <div class="fb-group">
                    <label class="fb-label" for="fb-content">反馈问题：</label>
                    <textarea class="fb-textarea" id="fb-content" rows="4" required></textarea>
                </div>
                <div class="fb-group">
                    <label class="fb-label" for="fb-email">邮箱：</label>
                    <input class="fb-input" type="email" id="fb-email" required>
                </div>                
                <button class="fb-button" type="submit">提交反馈</button>
            </form>
            <p class="fb-message" id="fb-message">提交成功！感谢您的反馈，祝您工作愉快！</p>
        </div>
    `;
